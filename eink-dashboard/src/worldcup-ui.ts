...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .wc-row { font-size: 21px; font-weight: 600; line-height: 26px; display: flex; flex-wrap: nowrap; align-items: center; gap: 7px; overflow: hidden; }
  ...
  .wc-table td { text-align: center; padding: 6px; font-weight: 600; line-height: 26px; }
  .wc-table td:nth-child(2) { text-align: left; font-weight: 600; }
  ...
  .wc-bteam { font-size: 19px; font-weight: 600; line-height: 24px; display: flex; align-items: center; justify-content: center; gap: 4px; }
