...
export const WORLDCUP_CACHE_VERSION = "v4"; // v4: penalty shootout result on the data blob (DECISIONS #50); v3: current-round phase (earliest active KO round) (#49); v2: fixture-aware top-2 flags (#47)
